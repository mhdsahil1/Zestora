      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-baseline gap-2">
            <span className="font-bold text-lg text-[#C65A00]">₹{(product.price * 100).toFixed(0)}</span>
            {product.originalPrice && (
              <span className="text-sm text-[#B09070] line-through">₹{(product.originalPrice * 100).toFixed(0)}</span>
            )}
          </div>
