          ...
          <form onSubmit={handleSubmit} className="p-8 pt-0 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                disabled={isLoading}
                className="flex items-center justify-center gap-2 py-3 bg-[#FAF8F5] border border-[#E8E1D9] rounded-xl text-[#4A3B32] font-medium hover:bg-white hover:shadow-sm transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {isLoading ? (
                  <div className="w-5 h-5 border-2 border-[#4A3B32]/30 border-t-[#4A3B32] rounded-full animate-spin" />
                ) : (
